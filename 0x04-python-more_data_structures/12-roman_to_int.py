...
def roman_to_int(roman_string):
    ...
    total_value = 0
    # Initialize num to keep track of the
    # numeric value of the current Roman numeral.
    current_roman_value = 0
    # A dictionary mapping each Roman numeral
    ...
    for idx in reversed(roman_string):
        ...
        # if the total so far is less than 5 times
        # the current numeral's value. Otherwise, subtract it.
        # This handles the Roman numeral subtraction rule
        # (e.g., IV is 4, IX is 9).
